QuickBite_Complete_47_Tasks

-- KIRAN ACADEMY - QUICKBITE - Fun + Company-Level MySQL Challenge
-- TOTAL TASKS: 47 (Level 1 to Final Boss)
...
(101, 'Spice Route', 'North Indian', 'Pune', 4.5, 420, 18500, 30, 32, 'Amit Sharma', 'Spice Route'),
...
(110, 'Coastal Curry', 'Seafood', 'Goa', 4.6, 750, 9800, 29, 48, 'Riya Fernandes', 'Coastal Curry'),
...
(115, 'Sushi Street', 'Japanese', 'Mumbai', 4.8, 920, 7600, 99, 50, 'Meera Shah', 'Sushi Street'),
...
(118, 'Hyderabadi House', 'Biryani', 'Hyderabad', 4.6, 430, 35900, 29, 37, 'Faizan Ali', 'Hyderabadi House'),
(119, 'Pasta Palace', 'Italian', 'Bengaluru', 4.5, 660, 10900, 40, 41, 'Nikhil Rao', 'Pasta Palace'),
(120, 'Sweet Cravings', 'Desserts', 'Pune', 4.7, 280, 20300, 19, 20, 'Pooja Patil', 'Sweet Cravings'),
(121, 'Kabab Kingdom', 'Mughlai', 'Delhi', 4.4, 530, 14100, 49, 44, 'Sameer Khan', 'Kabab Kingdom'),
...
(128, 'Namma Meals', 'South Indian', 'Bengaluru', 4.4, 275, 23000, 19, 27, 'Kavya Shetty', 'Namma Meals'),
...
-- LEVEL 2: Recommendation Team (11-20)
-- 11
