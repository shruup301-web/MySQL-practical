...
-- Task 3: Create a table named employees with the following columns.
...
-- Task 6: Insert employee 101, Rahul Patil, Development, 45000, Pune, 2026-01-10, Active
INSERT INTO employees VALUES (101, 'Rahul Patil', 'Development', 45000, 'Pune', '2026-01-10', 'Active');

-- Task 7: Insert employee 102, Priya Sharma, Testing, 38000, Mumbai, 2026-02-15, Active
INSERT INTO employees VALUES (102, 'Priya Sharma', 'Testing', 38000, 'Mumbai', '2026-02-15', 'Active');

-- Task 8: Insert employee 103, Amit Joshi, Development, 52000, Pune, 2025-12-05, Active
INSERT INTO employees VALUES (103, 'Amit Joshi', 'Development', 52000, 'Pune', '2025-12-05', 'Active');

-- Task 9: Insert employee 104, Sneha Kulkarni, HR, 35000, Nashik, 2026-03-20, Active
INSERT INTO employees VALUES (104, 'Sneha Kulkarni', 'HR', 35000, 'Nashik', '2026-03-20', 'Active');

-- Task 10: Insert employee 105, Rohan Deshmukh, Support, 30000, Mumbai, 2026-04-01, Inactive
INSERT INTO employees VALUES (105, 'Rohan Deshmukh', 'Support', 30000, 'Mumbai', '2026-04-01', 'Inactive');

-- Task 11: Insert employee 106, Anjali More, Testing, 42000, Pune, 2026-05-12, Active
